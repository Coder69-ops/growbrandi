                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-xs font-medium text-slate-600 dark:text-slate-300 tracking-wide uppercase">Growth Ecosystem v2.0</span>
                        </motion.div>
                        ...
                        <div className="border-t border-slate-200 dark:border-white/10 pt-8">
                            <p className="text-sm text-slate-500 dark:text-slate-400 mb-4 font-medium uppercase tracking-wider">Powering growth on:</p>
                            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6">
                                <img src="/logos/shopify.svg" alt="Shopify" className="h-8 w-auto" />
                                <img src="/logos/wordpress.svg" alt="WordPress" className="h-8 w-auto" />
                                <img src="/logos/meta.svg" alt="Meta" className="h-6 w-auto" />
                                <img src="/logos/google-ads.svg" alt="Google Ads" className="h-7 w-auto" />
                            </div>
                        </div>
                    </motion.div>

                    {/* 2. Right Side: The Visual Cluster (Span 6) */}
                    <motion.div
                        variants={itemVariants}
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Card 2: AI Code Editor (Behind) - Tech/Dev Vibe */}
                            <motion.div
                            ...
                            {/* Card 1: Social Media (Front & Center) - Enhanced Realism */}
                            <motion.div
                                ...
                                <div className="relative h-full w-full bg-slate-100 dark:bg-slate-950 rounded-[38px] overflow-hidden">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 h-[35%] bg-white dark:bg-slate-900/95 backdrop-blur-xl p-5 flex flex-col justify-between z-20">
                                        ...
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            <div>
                                                <div className="text-xs font-bold text-slate-900 dark:text-white">Viral Campaign</div>
                                        ...
                                        <div className="grid grid-cols-3 gap-1.5 mt-1">
                                            <div className="flex flex-col items-center p-1.5 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                                ...
                                                <span className="text-[9px] text-slate-500 uppercase tracking-wider">Views</span>
                                            </div>
                                            <div className="flex flex-col items-center p-1.5 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                                <span className="font-bold text-base text-slate-900 dark:text-white">145K</span>
                                                <span className="text-[9px] text-slate-500 uppercase tracking-wider">Likes</span>
                                            </div>
                                            <div className="flex flex-col items-center p-1.5 rounded-lg bg-slate-50 dark:bg-slate-800/50">
                                                <span className="font-bold text-base text-green-500">+12%</span>
                                                <span className="text-[9px] text-slate-500 uppercase tracking-wider">CTR</span>
                                            </div>
                                        </div>
                    ...
                    {/* 3. Tech Stack Carousel (Preserved) */}
                    <motion.div
                        variants={itemVariants}
