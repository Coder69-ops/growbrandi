        ...
        <section className="py-20 px-4 relative">
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            ...
            >
              <Link to="/contact">
                <motion.button
                  className="bg-gradient-to-r from-blue-500 to-blue-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-blue-600 hover:to-blue-600 transition-all duration-300 flex items-center justify-center gap-2 w-full sm:w-auto shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(59,130,246,0.5)]"
