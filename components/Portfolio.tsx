                    ...
                    <div className="container mx-auto max-w-5xl relative z-10">
                        ...
                        >
                            ...
                            <p className="text-slate-600 dark:text-zinc-400 text-xl md:text-2xl mb-12 max-w-2xl mx-auto font-light">
                                Top brands trust us to build their digital presence.
                                Join the elite circle of businesses we've transformed.
                            </p>
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-6 mt-10 opacity-80">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium text-slate-500 dark:text-zinc-500">100% Satisfaction Guarantee</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-1.5 h-1.5 rounded-full bg-blue-500" />
                                    <span className="text-sm font-medium text-slate-500 dark:text-zinc-500">Secure Payments</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-1.5 h-1.5 rounded-full bg-purple-500" />
                                    <span className="text-sm font-medium text-slate-500 dark:text-zinc-500">24/7 Support</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
