                        ...
                        <div className="space-y-6 max-w-2xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className="w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-900"
                                        placeholder="e.g. GrowBrandi Team"
                                        value={settings.global?.defaultAuthor || ''}
                                        onChange={(e) => setSettings(prev => ({
                                            ...prev,
                                            global: { ...prev.global, defaultAuthor: e.target.value }
                                        }))}
                                    />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <input
                                        type="text"
                                        className="w-full px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 font-mono text-sm"
                                        placeholder="https://..."
                                        value={settings.global?.defaultOgImage || ''}
                                        onChange={(e) => setSettings(prev => ({
                                            ...prev,
                                            global: { ...prev.global, defaultOgImage: e.target.value }
                                        }))}
                                    />
                                    {/* Helper to pick from assets could go here */}
                                </div>
                                {settings.global?.defaultOgImage && (
                                    <div className="mt-2 w-32 h-16 rounded overflow-hidden border border-slate-200 dark:border-slate-600 bg-slate-100">
                                        <img src={settings.global.defaultOgImage} alt="OG Preview" className="w-full h-full object-cover" />
                                    </div>
                                )}
                            </div>
                        </div>
